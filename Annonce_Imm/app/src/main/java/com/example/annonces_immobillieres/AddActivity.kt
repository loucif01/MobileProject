...
//        private var item_mail: TextView? = null
        ...
        val announce=Announce(type_selected,wilaya_selected,description,"","","",username,mail,mobile,0)
        Announces.instance.add_annonce(announce)


        val intent = Intent(this, MainActivity::class.java)
        intent.putExtra("announce_added",true)
        onBackPressed()
