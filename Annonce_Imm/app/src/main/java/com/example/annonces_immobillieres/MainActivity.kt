...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    val announces = Announces.instance.listAnnonces
...
//    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent.extras!=null)
            announceAdded=intent.extras["announce_added"] as Boolean
...
//        rv_animal_list.layoutManager = GridLayoutManager(this, 2)
        ...
        val listAnnouncesAdapter = ListAdapter(announces)
        rv_animal_list.adapter = listAnnouncesAdapter
        ...
        floating_search_view.setOnQueryChangeListener(object : FloatingSearchView.OnQueryChangeListener {
            override fun onSearchTextChanged(oldQuery: String?, newQuery: String?) {
                listAnnouncesAdapter.filter(newQuery)
